...
public class SistemaDoacoes {
    ...
    public void somarTotalDoacoes(String tipoTotal) {
        String arquivo = null;
            ...
            while ((linha = reader.readLine()) != null) {
                ...
                if (partes.length >= 2) {
                    try {
                        ...
                        System.out.println("Erro na doação: " + partes[1]);
                    }
                }
            }
        } catch (IOException e) {
        ...
        System.out.println("Total de doações " + tipoTotal + ": " + total);
    }
    ...
    public void listaDoacoes(String tipoListaDoacao) {
        ...
        switch (tipoListaDoacao.toLowerCase()) {
            ...
            case "roupa":
                ...
                break;
            default:
                System.out.println("doação inválido.");
                return;
        }
    
        System.out.println("Lista de doações do tipo: " + tipoListaDoacao);
